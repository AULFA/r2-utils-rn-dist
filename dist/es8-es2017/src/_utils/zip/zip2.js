        ...
        return new Promise(async (resolve, reject) => {
            ...
            const success = async (res) => {
                ...
                if (!res.headers["accept-ranges"]
                    ...
                    follow_redirects_1.http.get(Object.assign(Object.assign({}, new URL(filePath)), { headers: {} }))
            ...
            follow_redirects_1.http.request(Object.assign(Object.assign({}, new URL(filePath)), { headers: {}, method: "HEAD" }))
                .on("response", success)
                .on("error", failure)
                .end();
        });
